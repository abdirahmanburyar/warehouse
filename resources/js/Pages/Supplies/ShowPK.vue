<template>
    <AuthenticatedLayout title="Packing List" description="Track Your Packing List" img="/assets/images/orders.png">
                ...
                <table class="min-w-full border border-black">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-black uppercase tracking-wider border border-black">Action</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-black">
                        <tr v-for="(group, packing_list_number) in props.packing_list" :key="packing_list_number">
                            ...
                            <td class="px-6 py-4 border border-black">
                                <Link :href="route('supplies.packing-list.show', group.id)" class="text-indigo-600 hover:text-indigo-900">
                                    View
                                </Link>
                            </td>
                        </tr>
