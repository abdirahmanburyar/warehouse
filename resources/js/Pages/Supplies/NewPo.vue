        ...
        <div class="">
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div v-else-if="selectedSupplier" class="grid grid-cols-1 md:grid-cols-3 gap-6 bg-gray-50 rounded-lg p-4">
                        <div>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-900">Date: {{ moment().format('LL') }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    <table class="min-w-full">
                        <thead class="bg-gray-50 border-b border-gray-200">
                            <tr>
                                <th class="w-[40px] px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">#</th>
                                <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Item</th>
                                <th class="w-[150px] px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Barcode</th>
                                <th class="w-[150px] px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Dose</th>
                                <th class="w-[100px] px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">Qty</th>
                                <th class="w-[120px] px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">Unit Cost</th>
                                <th class="w-[120px] px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">Amount</th>
                            ...
                            <tr v-for="(item, index) in form.items" :key="index" class="hover:bg-gray-50">
                                ...
                                <td class="px-3 py-2 relative">
                                    <div class="relative">
                                        ...
                                        >
                                        <div 
                                            v-if="item.searchQuery && filteredProducts[index]?.length > 0" 
