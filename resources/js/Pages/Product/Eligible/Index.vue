<template>
    ...
    >
        ...
        <div class="mb-4 p-4 bg-white shadow rounded-lg">
            ...
            <div v-if="importError" class="mt-2 text-red-500">
                {{ importError }}
            </div>
            <div v-if="importSuccess" class="mt-2 text-green-500">
                {{ importSuccess }}
            </div>
            <div class="mt-2 text-sm text-gray-600">
                Upload an Excel file (.xlsx/.xls) with columns:
                item_description, facility_type
            </div>
        </div>
        ...
        <div class="flex items-center justify-between mt-3">
            ...
            <div class="ml-3">
                <select v-model="perPage" class="w-[200px]" @change="props.filters.page = 1">
        ...
        <div class="py-6">
            <table class="w-full text-sm text-left text-black">
                <thead>
                    <tr>
                        <th class="p-4 border border-black">Item Name</th>
                        <th class="p-4 border border-black">Facility Type</th>
                ...
                <tbody>
                    <tr v-for="item in eligibleItems.data" :key="item.id">
                        ...
                        <td class="p-4 border border-black">
                            <div class="flex items-center space-x-3">
                                <Link
                                    :href="
                                        route('products.eligible.edit', item.id)
                                    "
                    ...
                    <tr v-if="eligibleItems.data.length === 0">
                        <td
                            colspan="4"
                            class="p-4 border border-black text-center"
                        >
                            <span
