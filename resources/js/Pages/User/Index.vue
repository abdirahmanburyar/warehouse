        ...
        <div class="">
            <div class="overflow-hidden bg-white sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <!-- Search and Add User -->
                    <div
                        class="flex flex-col gap-4 mb-6 md:flex-row md:justify-between md:items-center"
                    >
                        ...
                        <button
                            @click="openModal()"
                            class="flex items-center justify-center px-4 py-2 text-white transition duration-150 bg-blue-600 rounded-lg shadow-sm hover:bg-blue-700"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                class="w-5 h-5 mr-2"
                    ...
                    <div class="overflow-x-auto bg-white rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th
                                        class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase transition cursor-pointer group hover:bg-gray-100"
                                        @click="sort('id')"
                                    >
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                >
                                    ...
                                    <td
                                        class="flex px-6 py-4 space-x-2 text-sm font-medium whitespace-nowrap"
                                    >
                                        <button
                                            @click="openRolesModal(user)"
                                            class="flex items-center px-3 py-1 text-indigo-600 transition-colors bg-indigo-100 rounded-md hover:text-indigo-900 hover:bg-indigo-200"
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                class="w-4 h-4 mr-1"
                                        ...
                                        <button
                                            ...
                                            class="flex items-center px-3 py-1 text-blue-600 transition-colors bg-blue-100 rounded-md hover:text-blue-900 hover:bg-blue-200"
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                class="w-4 h-4 mr-1"
                                        ...
                                        <button
                                            ...
                                            class="flex items-center px-3 py-1 text-red-600 transition-colors bg-red-100 rounded-md hover:text-red-900 hover:bg-red-200"
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                class="w-4 h-4 mr-1"
        ...
        <Modal :show="showModal" @close="closeModal">
            <div class="p-6">
                ...
                <div class="mt-4">
                    <div
                        v-if="errors"
                        class="p-4 mb-4 border-l-4 border-red-500 rounded-md bg-red-50"
                    >
                        <div
                            v-for="(error, key) in errors"
                            :key="key"
                            class="flex items-start mb-1 text-sm text-red-700 last:mb-0"
                        >
                            <svg
                    ...
                    <form @submit.prevent="submitForm" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <TextInput
                                    id="name"
                                    type="text"
                                    class="block w-full mt-1 transition border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                    v-model="form.name"
                                    required
                                    :disabled="isSubmitted || processing"
                        ...
                        <div>
                            ...
                            <span class="block mt-1 text-sm text-gray-500"
                                >Assign user to a specific warehouse or leave
                                empty for global access</span
                            >
                        </div>
                        ...
                        <div>
                            ...
                            <span class="block mt-1 text-sm text-gray-500"
                                >Assign user to a specific facility or leave
                                empty for global access</span
                            >
                        </div>
                        ...
                        >
                            <button
                                type="button"
                                class="px-4 py-2 mr-2 text-gray-800 transition bg-gray-200 rounded-lg hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 disabled:opacity-50"
                                @click="closeModal"
                                :disabled="isSubmitted || processing"
                            >
                                Cancel
                            ...
                            <button
                                type="submit"
                                class="flex items-center px-4 py-2 text-white transition bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 disabled:opacity-75"
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <p class="mb-2 text-sm text-gray-500">
                                    Select the roles you want to assign to this
                                    user
                                </p>
                                <SelectInput
                                    id="roles"
        ...
        <Modal :show="showDeleteModal" @close="closeDeleteModal">
            <div class="p-6">
                ...
                <div class="flex justify-end space-x-3">
                    <button
                        type="button"
                        class="px-4 py-2 text-gray-800 transition bg-gray-200 rounded-lg hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 disabled:opacity-50"
                        @click="closeDeleteModal"
                        :disabled="isSubmitted || processing"
                    >
                        Cancel
                    ...
                    <button
                        @click="deleteUser"
                        class="flex items-center px-4 py-2 text-white transition bg-red-600 rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 disabled:opacity-75"
                        :disabled="processing || isSubmitted"
                    >
                        <svg
                            v-if="isSubmitted"
...
watch(
    [() => search.value, () => sort_field.value, () => sort_direction.value],
    () => debouncedSearch()
);
...
const openModal = (user = null) => {
    ...
    if (user) {
        ...
        form.value.facility_id = user.facility_id;
    } else {
        form.value.id = null;
        form.value.name = "";
        form.value.username = "";
...
const submitForm = async () => {
    ...
    const headers = isInSettingsPage ? { "X-From-Settings": "true" } : {};

    await axios
        .post(route("users.store"), form.value, {
            headers: headers,
        })
        .then((response) => {
...
const deleteUser = () => {
    ...
    deleteForm.delete(route("users.destroy", userToDelete.value.id), {
        ...
        onError: (errors) => {
            toast.error(
                errors.error || "An error occurred while deleting the user"
            );
