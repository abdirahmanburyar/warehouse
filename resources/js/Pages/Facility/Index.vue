            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-700 px-8 py-8">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div class="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
                        <!-- Excel Upload Button -->
                        <button v-if="$page.props.auth.can.facility-manage" @click="openUploadModal" 
                        ...
                        <!-- Add Facility Button -->
                        <Link v-if="$page.props.auth.can.facility-manage" :href="route('facilities.create')"
                        ...
                        >
                            ...
                            <td class="px-3 py-2 whitespace-nowrap text-center">
                                <div class="flex items-end justify-end space-x-2">
                                    <Link
                                        v-if="$page.props.auth.can.facility-manage"
                                    ...
                                    <span v-if="!$page.props.auth.can.facility-manage" class="text-xs text-gray-500 italic">
                                        View Only
                                    </span>
                                </div>
                            </td>
