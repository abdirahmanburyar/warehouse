                        ...
                        <td class="px-2 py-2 whitespace-nowrap text-xs text-gray-600 border-b"
                            ...
                            <div class="text-sm">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-gray-900">{{ order.tracking_data.fulfillment_percentage }}%</span>
                                </div>
                            </div>
                        </td>
                        <td class="px-2 py-2 whitespace-nowrap border-b" style="border-bottom: 1px solid #B7C6E6;">
                            <div class="w-full bg-gray-200 rounded-full h-2">
                                <div class="bg-green-600 h-2 rounded-full"
                                    :style="{ width: order.tracking_data.fulfillment_percentage + '%' }"></div>
                            </div>
                            <div class="text-xs text-gray-500 mt-1">
                                {{ order.tracking_data.fulfillment_percentage }}% Fulfilled
                            </div>
                        </td>
                    </tr>
                </tbody>
...
const exportToExcel = () => {
    ...
    XLSX.writeFile(wb, "order_tracking_report.xlsx");
};
