...
const handleSubmit = async () => {
    ...
    .then(async (result) => {
        ...
        await axios.post(route('transfers.store'), {
            ...
            <div class="p-1 text-gray-900 mb-6">
                <div class="flex flex-col space-y-6">
                    <div class="flex items-start flex-col w-full gap-5 mb-6">
                        ...
                        <div class="w-[400px]">
                            <Multiselect v-model="selectedDestination" :options="destinations" :searchable="true"
                                :create-option="false" placeholder="Select destination" label="name" track-by="id" />
                        </div>
                    </div>
                                ...
                                <tr class="">
                                    ...
                                    <td class="px-6 py-3 text-sm">
                                        <div class="space-y-1">
                                            ...
                                            <p>Expire Date: {{ moment(inventory.expiry_date).format('DD/MM/YYYY') ||
                                                'N/A' }}</p>
                    ...
                    <div class="flex justify-end items-center space-x-6">
                        <a :href="route('expired.index')" :disabled="loading" class="text-gray-500 hover:text-gray-700">
                            Exit
                        </a>
                        <button type="submit" :disabled="isSubmitting || !selectedDestination || !quantityToTransfer"
