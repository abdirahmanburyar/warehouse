                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6 flex flex-wrap items-center gap-4">
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            ...
                            <div class="w-48">
                                <TextInput v-model="location" type="text" class="w-full"
                                    placeholder="Filter by location" @keyup.enter="applyFilters" />
                            </div>
        ...
        <Modal :show="showAddModal" @close="showAddModal = false">
            <div class="p-6">
                <form @submit.prevent="submitForm">
                    <h2 class="text-lg font-medium text-gray-900">{{ showEditModal ? 'Edit' : 'Add' }} Inventory Item</h2>
                    ...
                    <div class="mt-6 flex justify-end">
                        <SecondaryButton @click="showAddModal = false" :disabled="isSubmitting" class="mr-2">Cancel</SecondaryButton>
                        <PrimaryButton type="submit" :disabled="isSubmitting">{{ showEditModal ? isSubmitting ? 'Processing...' : 'Update' : isSubmitting ? 'Processing...' : 'Create' }}</PrimaryButton>
                    </div>
                </form>
            </div>
        </Modal>
