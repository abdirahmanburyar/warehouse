    ...
    <div class="app-container">
        ...
        <div :class="['sidebar', { 'sidebar-open': sidebarOpen }]">
            ...
            <div class="sidebar-menu">
                ...
                <div class="menu-content">
                    <div class="menu-icon">
                        <img src="/assets/images/transfer.png" class="transfer-icon" style="height: 24px" />
                    </div>
                ...
                <div class="menu-content">
                    <div class="menu-icon">
                        <img src="/assets/images/product.png" class="product-icon" style="height: 24px" />
                    </div>
                ...
                <div class="menu-content">
                    <div class="menu-icon">
                        <img src="/assets/images/expired.png" class="expired-icon" style="height: 24px" />
                    </div>
                ...
                <div class="menu-content">
                    <div class="menu-icon">
                        <img src="/assets/images/supplies.png" class="supplies-icon" style="height: 24px" />
                    </div>
